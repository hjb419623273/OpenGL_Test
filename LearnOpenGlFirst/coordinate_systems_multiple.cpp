...
void framebuffer_size_callback7(GLFWwindow *window, int width, int height);
...
int main7()
{
	...
	glfwSetFramebufferSizeCallback(window, framebuffer_size_callback7);
...
void processInput7(GLFWwindow *window)
{
	...
	float cameraSpeed = static_cast<float>(2.5 * deltaTime1);
