...
void framebuffer_size_callback6(GLFWwindow *window, int width, int height);
void processInput6(GLFWwindow *window);
...
int main6()
{
	...
	glfwSetFramebufferSizeCallback(window, framebuffer_size_callback6);
